<?php
	...
	function curtir(&$id_post,&$id_usuario,&$pagina,&$conexao,&$id_amigo,&$nome_amigo,&$ft_amigo,&$like_post){

		if($conexao->connect_error){
			echo "Erro de Conexão! <br>".$conexao->connect_error;
		}

		$sql = "INSERT INTO `curtidas`(`id_post`, `id_bruxo`) VALUES ('$id_post','$id_usuario')";
	...
	if (isset($_GET['curtir'])) {
	    ...
	    curtir($id_post,$id_usuario,$pagina,$conexao,$id_amigo,$nome_amigo,$ft_amigo,$like_post);
