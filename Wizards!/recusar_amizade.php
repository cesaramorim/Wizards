<?php
	...
	function recusar(&$id_usuario,&$id_bruxo,&$conexao,&$nm_amigo,&$ft_amigo,&$pagina){
		...
		if($conexao->connect_error){
	 	...
	 	$sql = "DELETE FROM `amizades` WHERE ((id_bruxo_2 = '$id_usuario') and (id_bruxo_1 = '$id_bruxo'))";
	...
	if (isset($_GET['recusar'])) {
	    ...
	    recusar($id_usuario,$id_bruxo,$conexao,$nm_amigo,$ft_amigo,$pagina); 
	}
